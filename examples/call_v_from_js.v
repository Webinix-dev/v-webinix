...
<html>
	...
	<body>
		...
		<br>
		<button onclick="webinix.handleInt(123, 456, 789);">Call handle_int()</button>
		<br>
		<button onclick="webinix.handleBool(true, false);">Call handle_bool()</button>
		<br>
		...
		<script>
			async function MyJS() {
				...
				const result = await webinix.getResponse(number);
...
// JavaScript: `webinix.handleStr('Hello', 'World');`
...
// JavaScript: `webinix.handleInt(123, 456, 789);`
...
// JavaScript: webinix.handleBool(true, false);
...
// JavaScript: `const result = await webinix.getResponse(number);`
